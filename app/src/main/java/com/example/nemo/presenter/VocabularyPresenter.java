...
public class VocabularyPresenter implements IVocabularyConstract.IPresenter {
    private static final String TAG = "VocabularyPresenter";
    private IVocabularyConstract.IView mView;
    private ApiService apiService;

    public VocabularyPresenter(IVocabularyConstract.IView view) {
        this.mView = view;
